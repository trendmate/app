...
//                     child: IconButton(
//                         color: Colors.red,
//                         icon: Icon(productsProvider.favoritesSet.contains(
//                                 productsProvider.products[widget.idx].productId)
//                             ? Icons.favorite
//                             : Icons.favorite_border),
//                         onPressed: () {
//                           if (productsProvider.favoritesSet.contains(
//                               productsProvider
//                                   .products[widget.idx].productId)) {
//                             productsProvider.removeFavorites(productsProvider.favorites[widget.idx]);
//                           }
//                           else
//                           {
//                             productsProvider.addFavorites(productsProvider
//                                 .products[widget.idx].productId);
//                           }
//                         }),
//                   ),
